 ...
 */class ot extends ${constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const s=i?.renderBefore??e;let n=s._$litPart$;if(void 0===n){const t=i?.renderBefore??null;s._$litPart$=n=new G(e.insertBefore(P(),t),t,void 0,i??{})}return n._$AI(t),n})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return q}}ot._$litElement$=!0,ot.finalized=!0,rt.litElementHydrateSupport?.({LitElement:ot});const at=rt.litElementPolyfillSupport;at?.({LitElement:ot}),(rt.litElementVersions??=[]).push("4.2.2");const lt=["critical","error","warning","info","success"],dt=[{value:"state",label:"Specific state"},{value:"on",label:"Turns on"},{value:"off",label:"Turns off"},{value:"any",label:"Any change"},{value:"above",label:"Above threshold"},{value:"below",label:"Below threshold"},{value:"unavailable",label:"Unavailable / Unknown"}],ct=[{value:"info",label:"Info"},{value:"success",label:"Success"},{value:"warning",label:"Warning"},{value:"error",label:"Error"},{value:"critical",label:"Critical"}];function ht(){return Date.now().toString(36)+Math.random().toString(36).slice(2,8)}function pt(t,e){return t?t.replace(/\{(\w+)\}/g,(t,i)=>void 0!==e[i]?e[i]:`{${i}}`):""}function ut(t){if(null==t||""===t||!1===t)return 0;if("number"==typeof t)return t>0?1e3*t:0;const e=String(t).trim().toLowerCase();if(!e)return 0;const i=e.match(/^(\d+):(\d+)(?::(\d+))?$/);if(i)return void 0!==i[3]?1e3*(3600*Number(i[1])+60*Number(i[2])+Number(i[3])):1e3*(60*Number(i[1])+Number(i[2]));const s=e.match(/^(\d+(?:\.\d+)?)\s*(s|m|h|d|w)$/);if(s){const t=parseFloat(s[1]);switch(s[2]){case"s":return 1e3*t;case"m":return 60*t*1e3;case"h":return 3600*t*1e3;case"d":return 86400*t*1e3;case"w":return 604800*t*1e3}}const n=parseFloat(e);return!isNaN(n)&&n>0?1e3*n:0}class ft{constructor(t){this._key=`ha-notification-card-${t}`}load(){try{const t=localStorage.getItem(this._key);return t?JSON.parse(t):[]}catch{return[]}}save(t){try{localStorage.setItem(this._key,JSON.stringify(t))}catch{const e=t.slice(-50);localStorage.setItem(this._key,JSON.stringify(e))}}loadDismissed(){try{const t=localStorage.getItem(this._key+"-dismissed");return t?JSON.parse(t):{}}catch{return{}}}saveDismissed(t){try{localStorage.setItem(this._key+"-dismissed",JSON.stringify(t))}catch{}}loadMuted(){try{const t=localStorage.getItem(this._key+"-muted");return t?JSON.parse(t):{}}catch{return{}}}saveMuted(t){try{localStorage.setItem(this._key+"-muted",JSON.stringify(t))}catch{}}}customElements.define("notification-card",class extends ot{static get properties(){return{hass:{type:Object},_config:{type:Object,state:!0},_notifications:{type:Array,state:!0},_expanded:{type:Boolean,state:!0},_expandedId:{type:String,state:!0},_previousStates:{type:Object,state:!0},_dismissed:{type:Object,state:!0},_muted:{type:Object,state:!0},_swipeState:{type:Object,state:!0}}}constructor(){super(),this._notifications=[],this._expanded=!1,this._expandedId=null,this._previousStates={},this._dismissed={},this._muted={},this._swipeState={},this._store=null,this._expiryTimer=null,this._longPressTimer=null,this._initialized=!1,this._pendingForTimers={}}setConfig(t){if(!t.entities||!Array.isArray(t.entities))throw new Error("You need to define entities");this._config={title:t.title||"Notifications",card_id:t.card_id||"default",visible_count:t.visible_count??4,expiry_minutes:t.expiry_minutes??0,hide_when_empty:t.hide_when_empty??!1,show_empty:t.show_empty??!0,empty_text:t.empty_text||"No notifications",show_header:t.show_header??!0,show_badge:t.show_badge??!0,show_clear_all:t.show_clear_all??!0,show_timestamp:t.show_timestamp??!0,sort_by:t.sort_by||"newest",group_repeated:t.group_repeated??!0,vibrate:t.vibrate??!1,max_stored:t.max_stored??100,entities:t.entities.map(t=>({entity:t.entity,name:t.name||null,trigger:t.trigger||"any",state:t.state||null,threshold:null!=t.threshold?Number(t.threshold):null,severity:t.severity||"info",message:t.message||null,icon:t.icon||null,expiry_minutes:t.expiry_minutes??null,for:t.for||null,_forMs:ut(t.for),enabled:t.enabled??!0}))},this._store=new ft(this._config.card_id),this._notifications=this._store.load(),this._dismissed=this._store.loadDismissed(),this._muted=this._store.loadMuted()}getCardSize(){const t=this._activeNotifications().length,e=Math.min(t,this._config?.visible_count??4);return Math.max(1,e+1)}static getConfigElement(){return document.createElement("notification-card-editor")}static getStubConfig(){return{title:"Notifications",visible_count:4,expiry_minutes:0,entities:[{entity:"",trigger:"any",severity:"info",message:"{name} changed to {state}"}]}}connectedCallback(){super.connectedCallback(),this._startExpiryTimer()}disconnectedCallback(){super.disconnectedCallback(),this._stopExpiryTimer(),this._clearAllForTimers()}_clearAllForTimers(){for(const t of Object.keys(this._pendingForTimers))clearTimeout(this._pendingForTimers[t].timerId);this._pendingForTimers={}}updated(t){t.has("hass")&&this.hass&&this._config&&this._evaluateEntities()}_evaluateEntities(){if(!this.hass||!this._config)return;const t=[];for(const e of this._config.entities){if(!e.enabled)continue;if(this._muted[e.entity]){if(this._muted[e.entity]>Date.now())continue;delete this._muted[e.entity],this._store.saveMuted(this._muted)}const i=this.hass.states[e.entity];if(!i)continue;const s=i.state,n=this._previousStates[e.entity];if(this._previousStates[e.entity]=s,!this._initialized)continue;if(void 0===n)continue;if(n===s)continue;const r=this._checkTrigger(e,s,n),o=e._forMs||0,a=e.entity+"|"+(e.trigger||"any");if(!r){this._pendingForTimers[a]&&(clearTimeout(this._pendingForTimers[a].timerId),delete this._pendingForTimers[a]);continue}if(o>0){this._pendingForTimers[a]&&clearTimeout(this._pendingForTimers[a].timerId),this._pendingForTimers[a]={timerId:setTimeout(()=>{this._fireForNotification(e,a)},o),entCfg:e,state:s,prevState:n,startedAt:Date.now()};continue}const l=e.name||i.attributes.friendly_name||e.entity,d=e.message?pt(e.message,{name:l,state:s,previous:n,entity:e.entity}):`${l}: ${s}`,c={id:ht(),entity:e.entity,severity:e.severity,message:d,state:s,previous:n,timestamp:Date.now(),icon:e.icon||i.attributes.icon||null,expiry_minutes:e.expiry_minutes??this._config.expiry_minutes,count:1};t.push(c)}if(!this._initialized)return this._initialized=!0,void this._checkInitialStates();if(t.length>0){let e=[...this._notifications];for(const i of t){if(this._config.group_repeated){const t=e.find(t=>t.entity===i.entity&&t.severity===i.severity&&!this._dismissed[t.id]);if(t){t.message=i.message,t.state=i.state,t.previous=i.previous,t.timestamp=i.timestamp,t.count=(t.count||1)+1;continue}}e.push(i)}e.length>this._config.max_stored&&(e=e.slice(-this._config.max_stored)),this._notifications=e,this._store.save(this._notifications),this._config.vibrate&&navigator.vibrate&&navigator.vibrate(100),this.requestUpdate()}}_checkInitialStates(){if(!this.hass||!this._config)return;const t=[];for(const e of this._config.entities){if(!e.enabled)continue;const i=this.hass.states[e.entity];if(!i)continue;const s=i.state;if(!this._isInTriggeredState(e,s))continue;const n=e._forMs||0;if(n>0){const t=i.last_changed?new Date(i.last_changed).getTime():0,r=Date.now()-t;if(r<n){const t=e.entity+"|"+(e.trigger||"any"),i=n-r;this._pendingForTimers[t]||(this._pendingForTimers[t]={timerId:setTimeout(()=>{this._fireForNotification(e,t)},i),entCfg:e,state:s,prevState:"unknown",startedAt:Date.now()});continue}}const r=e.name||i.attributes.friendly_name||e.entity,o=e.message?pt(e.message,{name:r,state:s,previous:"unknown",entity:e.entity}):`${r}: ${s}`,a={id:ht(),entity:e.entity,severity:e.severity,message:o,state:s,previous:"unknown",timestamp:Date.now(),icon:e.icon||i.attributes.icon||null,expiry_minutes:e.expiry_minutes??this._config.expiry_minutes,count:1};if(this._config.group_repeated){const t=this._notifications.find(t=>t.entity===a.entity&&t.severity===a.severity&&!this._dismissed[t.id]);if(t)continue}const l=this._notifications.find(t=>t.entity===a.entity&&!this._dismissed[t.id]);l||t.push(a)}t.length>0&&(this._notifications=[...this._notifications,...t],this._store.save(this._notifications),this.requestUpdate())}_fireForNotification(t,e){if(delete this._pendingForTimers[e],!this.hass||!this._config)return;const i=this.hass.states[t.entity];if(!i)return;const s=i.state;if(!this._isInTriggeredState(t,s))return;if(this._muted[t.entity]){if(this._muted[t.entity]>Date.now())return}const n=t.name||i.attributes.friendly_name||t.entity,r=t.message?pt(t.message,{name:n,state:s,previous:"unknown",entity:t.entity}):`${n}: ${s}`,o={id:ht(),entity:t.entity,severity:t.severity,message:r,state:s,previous:"unknown",timestamp:Date.now(),icon:t.icon||i.attributes.icon||null,expiry_minutes:t.expiry_minutes??this._config.expiry_minutes,count:1};let a=[...this._notifications];if(this._config.group_repeated){const t=a.find(t=>t.entity===o.entity&&t.severity===o.severity&&!this._dismissed[t.id]);if(t)return t.message=o.message,t.state=o.state,t.timestamp=o.timestamp,t.count=(t.count||1)+1,this._notifications=a,this._store.save(this._notifications),void this.requestUpdate()}a.push(o),a.length>this._config.max_stored&&(a=a.slice(-this._config.max_stored)),this._notifications=a,this._store.save(this._notifications),this._config.vibrate&&navigator.vibrate&&navigator.vibrate(100),this.requestUpdate()}_isInTriggeredState(t,e){switch(t.trigger){case"any":return!0;case"state":return e===t.state;case"on":return"on"===e;case"off":return"off"===e;case"unavailable":return"unavailable"===e||"unknown"===e;case"above":return null!=t.threshold&&!isNaN(Number(e))&&Number(e)>t.threshold;case"below":return null!=t.threshold&&!isNaN(Number(e))&&Number(e)<t.threshold;default:return!1}}_checkTrigger(t,e,i){switch(t.trigger){case"any":return!0;case"state":return e===t.state&&i!==t.state;case"on":return"on"===e&&"on"!==i;case"off":return"off"===e&&"off"!==i;case"unavailable":return("unavailable"===e||"unknown"===e)&&"unavailable"!==i&&"unknown"!==i;case"above":return null!=t.threshold&&!isNaN(Number(e))&&Number(e)>t.threshold&&(isNaN(Number(i))||Number(i)<=t.threshold);case"below":return null!=t.threshold&&!isNaN(Number(e))&&Number(e)<t.threshold&&(isNaN(Number(i))||Number(i)>=t.threshold);default:return!1}}_startExpiryTimer(){this._expiryTimer=setInterval(()=>this._purgeExpired(),3e4)}_stopExpiryTimer(){this._expiryTimer&&clearInterval(this._expiryTimer)}_purgeExpired(){const t=Date.now();let e=!1;for(const i of this._notifications){if(this._dismissed[i.id])continue;const s=i.expiry_minutes||0;s>0&&t-i.timestamp>6e4*s&&(this._dismissed[i.id]=!0,e=!0)}e&&(this._store.saveDismissed(this._dismissed),this.requestUpdate())}_activeNotifications(){let t=this._notifications.filter(t=>!this._dismissed[t.id]);switch(this._config?.sort_by){case"oldest":t.sort((t,e)=>t.timestamp-e.timestamp);break;case"severity":t.sort((t,e)=>lt.indexOf(t.severity)-lt.indexOf(e.severity));break;default:t.sort((t,e)=>e.timestamp-t.timestamp)}return t}_dismiss(t){this._dismissed[t]=!0,this._store.saveDismissed(this._dismissed),this.requestUpdate()}_dismissAll(){for(const t of this._notifications)this._dismissed[t.id]=!0;this._store.saveDismissed(this._dismissed),this._expanded=!1,this.requestUpdate()}_muteEntity(t,e=60){this._muted[t]=Date.now()+6e4*e,this._store.saveMuted(this._muted),this.requestUpdate()}_toggleExpand(){this._expanded=!this._expanded,this.requestUpdate()}_toggleDetail(t){this._expandedId=this._expandedId===t?null:t,this.requestUpdate()}_onTouchStart(t,e){const i=t.touches[0];this._swipeState={id:e,startX:i.clientX,startY:i.clientY,currentX:0,swiping:!1},this._longPressTimer=setTimeout(()=>{this._toggleDetail(e),this._swipeState={}},500)}_onTouchMove(t,e){if(!this._swipeState.id||this._swipeState.id!==e)return;const i=t.touches[0],s=i.clientX-this._swipeState.startX;if(i.clientY,this._swipeState.startY,Math.abs(s)>10&&(clearTimeout(this._longPressTimer),this._swipeState.swiping=!0),this._swipeState.swiping){t.preventDefault(),this._swipeState.currentX=s;const i=this.shadowRoot.querySelector(`[data-id="${e}"]`);if(i){const t=Math.max(0,1-Math.abs(s)/200);i.style.transform=`translateX(${s}px)`,i.style.opacity=t}}}_onTouchEnd(t,e){if(clearTimeout(this._longPressTimer),!this._swipeState.id||this._swipeState.id!==e)return;const i=this.shadowRoot.querySelector(`[data-id="${e}"]`);if(Math.abs(this._swipeState.currentX)>80){if(i){const t=this._swipeState.currentX>0?1:-1;i.style.transform=`translateX(${400*t}px)`,i.style.opacity="0",i.style.transition="transform 0.2s ease, opacity 0.2s ease",setTimeout(()=>this._dismiss(e),200)}}else i&&(i.style.transform="",i.style.opacity="",i.style.transition="transform 0.2s ease, opacity 0.2s ease",setTimeout(()=>{i&&(i.style.transition="")},200));this._swipeState={}}_setHidden(t){if(t){this.hidden=!0,this.style.setProperty("display","none","important"),this.style.setProperty("margin","0","important"),this.style.setProperty("padding","0","important");const t=this.parentElement;if(t){const e=[...t.children].filter(t=>t!==this&&!t.hidden);0===e.length&&(t.style.setProperty("display","none","important"),t.dataset.hiddenByNotifCard="1")}}else{this.hidden=!1,this.style.removeProperty("display"),this.style.removeProperty("margin"),this.style.removeProperty("padding");const t=this.parentElement;t?.dataset.hiddenByNotifCard&&(t.style.removeProperty("display"),delete t.dataset.hiddenByNotifCard)}}render(){if(!this._config)return L``;const t=this._activeNotifications();if(0===t.length&&this._config.hide_when_empty)return this._setHidden(!0),L``;this._setHidden(!1);const e=this._expanded?t:t.slice(0,this._config.visible_count),i=t.length>this._config.visible_count,s=t.length-this._config.visible_count;return L`
      <ha-card>
        ...
        <div class="card-content">
          ${0===t.length&&this._config.show_empty?L`
                <div class="empty">
    ...
    `}_renderNotification(t){const e=this._expandedId===t.id,i=t.icon||function(t){switch(t){case"critical":return"mdi:alert-octagon";case"error":return"mdi:alert-circle";case"warning":return"mdi:alert";case"success":return"mdi:check-circle";default:return"mdi:information"}}(t.severity),s=function(t){switch(t){case"critical":case"error":return"var(--error-color, #db4437)";case"warning":return"var(--warning-color, #ffa726)";case"success":return"var(--success-color, #43a047)";default:return"var(--info-color, #039be5)"}}(t.severity),n=this.hass?.states[t.entity];return L`
      <div
        ...
        <div class="notif-main">
          ...
          <div class="notif-body">
            ...
            <div class="notif-meta">
              ${this._config.show_timestamp?L`<span class="notif-time"
                  ...
                  >`:B}
              ${t.count>1?L`<span class="notif-count">×${t.count}</span>`:B}
            </div>
          </div>
          <button
            class="notif-dismiss"
        ...
        ${e?L`
              <div class="notif-detail">
                ...
                ${n?L`
                      ...
                      ${Object.entries(n.attributes).filter(([t])=>!["friendly_name","icon","entity_picture"].includes(t)).slice(0,8).map(([t,e])=>L`
                            <div class="detail-row">
    ...
    `}}),customElements.define("notification-card-editor",class extends ot{static get properties(){return{hass:{type:Object},_config:{type:Object,state:!0}}}setConfig(t){this._config={...t}}_dispatch(){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}_updateField(t,e){this._config={...this._config,[t]:e},this._dispatch()}_updateEntity(t,e,i){const s=[...this._config.entities||[]];s[t]={...s[t],[e]:i},this._config={...this._config,entities:s},this._dispatch()}_addEntity(){const t=[...this._config.entities||[],{entity:"",trigger:"any",severity:"info",message:"{name} changed to {state}"}];this._config={...this._config,entities:t},this._dispatch()}_removeEntity(t){const e=[...this._config.entities||[]];e.splice(t,1),this._config={...this._config,entities:e},this._dispatch()}render(){return this._config?L`
      <div class="editor">
        <div class="field">
          <label>Title</label>
          <input
        ...
        <div class="toggles">
          ${[["hide_when_empty","Hide card when empty",!1],["show_header","Show header",!0],["show_badge","Show badge",!0],["show_clear_all","Show clear all",!0],["show_timestamp","Show timestamps",!0],["show_empty","Show empty state",!0],["group_repeated","Group repeated",!0],["vibrate","Vibrate on new",!1]].map(([t,e,i])=>L`
              <label class="toggle">
                <input
                  type="checkbox"
            ...
            <div class="entity-card">
              ...
              <div class="row">
                <div class="field half">
                  ...
                  >
                    ${dt.map(t=>L`<option value="${t.value}">${t.label}</option>`)}
                  </select>
                </div>
                <div class="field half">
                  ...
                  >
                    ${ct.map(t=>L`<option value="${t.value}">${t.label}</option>`)}
                  </select>
                </div>
              </div>
              ...
              ${"state"===t.trigger?L`
                  ...
                  `:B}
              ${"above"===t.trigger||"below"===t.trigger?L`
                    <div class="field">
              ...
              ${"any"!==t.trigger?L`
                    <div class="field">
                      ...
                      <input
                        type="text"
                        .value=${t.for||""}
                        @input=${t=>this._updateEntity(e,"for",t.target.value||null)}
                        placeholder="10m"
                      />
                    </div>
                  `:B}
    ...
    `}}),window.customCards=window.customCards||[],window.customCards.push({type:"notification-card",name:"Notification Card",description:"Entity-driven notification center with swipe dismiss, severity levels, auto-expiry, and grouped alerts.",preview:!0,documentationURL:"https://github.com/robmarkoski/ha-notification-card"}),console.info("%c NOTIFICATION-CARD %c v2.1.0 ","color: white; background: #03a9f4; font-weight: bold; padding: 2px 6px; border-radius: 4px 0 0 4px;","color: #03a9f4; background: white; font-weight: bold; padding: 2px 6px; border-radius: 0 4px 4px 0; border: 1px solid #03a9f4;");
